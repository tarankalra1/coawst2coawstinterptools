function create_roms_netcdf_bndry_mwUL(fn,gn,t_clim,obc)
%
% jcw April 18, 2009
...
%                bry_time:units = "seconds since 2017-07-04 00:00:00" ;
%                bry_time:calendar = "gregorian" ;

% SCook's way
%brytimeID = netcdf.defVar(nc_bndry,'bry_time','double',brydimID);
%netcdf.putAtt(nc_bndry,brytimeID,'long_name','time since initialization');
%netcdf.putAtt(nc_bndry,brytimeID,'units','seconds since 2015-04-15 00:00:00') ;
%netcdf.putAtt(nc_bndry,brytimeID,'calendar','gregorian');

% This was in Z's format now changed to Salme's 
ztID = netcdf.defVar(nc_bndry,'zeta_time','double',zttdimID);
netcdf.putAtt(nc_bndry,ztID,'long_name','zeta_time');
netcdf.putAtt(nc_bndry,ztID,'units','seconds');
...
netcdf.putAtt(nc_bndry,v2ID,'units','seconds');
...
netcdf.putAtt(nc_bndry,v3ID,'units','seconds');
...
netcdf.putAtt(nc_bndry,slID,'units','seconds');
...
netcdf.putAtt(nc_bndry,tpID,'units','seconds');
netcdf.putAtt(nc_bndry,tpID,'field','temp_time, scalar, series');

%tsk 
sandID = netcdf.defVar(nc_bndry,'sand_time','double',sanddimID);
netcdf.putAtt(nc_bndry,sandID,'long_name','sand_time');
netcdf.putAtt(nc_bndry,sandID,'units','seconds');
netcdf.putAtt(nc_bndry,sandID,'field','sand_time, scalar, series');
...
netcdf.putAtt(nc_bndry,tmpnID,'field','temp_north, scalar, series');
 ...
 % sand 01 
 sandID = netcdf.defVar(nc_bndry,'sand_north_01','float',[xrhodimID s_rhodimID sanddimID]);
 ...
 netcdf.putAtt(nc_bndry,sandID,'field','sand_north_01, scalar, series');
...
netcdf.putAtt(nc_bndry,tmpsID,'field','temp_south, scalar, series');
 ...
 sandID = netcdf.defVar(nc_bndry,'sand_south_01','float',[xrhodimID s_rhodimID sanddimID]);
 netcdf.putAtt(nc_bndry,sandID,'long_name','suspended noncohesive sediment southern boundary condition');
 netcdf.putAtt(nc_bndry,sandID,'units','kilogram meter-3');
 netcdf.putAtt(nc_bndry,sandID,'field','sand_south_01, scalar, series');
...
netcdf.putAtt(nc_bndry,tmpeID,'field','temp_east, scalar, series');
 ...
 sandID = netcdf.defVar(nc_bndry,'sand_east_01','float',[erhodimID s_rhodimID sanddimID]);
 netcdf.putAtt(nc_bndry,sandID,'long_name','suspended noncohesive sediment eastern boundary condition');
 netcdf.putAtt(nc_bndry,sandID,'units','kilogram meter-3');
 netcdf.putAtt(nc_bndry,sandID,'field','sand_east_01, scalar, series');
...
netcdf.putAtt(nc_bndry,tmpwID,'field','temp_west, scalar, series');
 ...
 sandID = netcdf.defVar(nc_bndry,'sand_west_01','float',[erhodimID s_rhodimID sanddimID]);
