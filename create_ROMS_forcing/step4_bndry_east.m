...
srcFile='reedy_bry_north_test_june_westappend2.nc';
dstFile='reedy_bry_north_test_june_westeastappend2.nc';
...
for mm = init_1:init_end
   tt=mm-init_1+1;
   for k = 1:coarse_N
     temp_4d(1:ny_ref,k,tt)=temp_1d_tsk_east(k,tt); 
     salt_4d(1:ny_ref,k,tt)=salt_1d_tsk_east(k,tt); 
   end 
end 
...
%
% Convert the 4d array names into east 
[zeta_east,ubar_east,vbar_east,temp_east,salt_east,......
          u_east, v_east, sand_east_01, sand_east_02, .....
          sand_east_03, sand_east_04, sand_east_05]=...........
      save_eastbc(obc, zeta_ref, ubar_ref, vbar_ref, u_4d, v_4d, .....
temp_4d, salt_4d, .....
sand01_4d, sand02_4d, sand03_4d, sand04_4d, sand05_4d,count_1,count_end);

% append to the file 
create_append_roms_east(x_psi, x_rho, x_u, x_v, e_psi, e_rho, e_u, ....
e_v, s_rho, zeta_time, zeta_east, ubar_east, vbar_east, u_east, v_east, temp_east, salt_east, .....
sand_east_01, sand_east_02, sand_east_03, sand_east_04, sand_east_05, dstFile);
